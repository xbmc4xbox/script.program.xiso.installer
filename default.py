...
def extract_title_image(game_iso_folder):
  script_root_dir = addon.getAddonInfo("path")
  ...
  if not isfile('Z:\\TitleImage.xbx'):
    shutil.copy2(join(script_root_dir, 'resources', 'media', 'missing.jpg'), default_tbn)
...
if __name__ == "__main__":
  log("| {} loaded.".format(addon.getAddonInfo("path")))
